...
- Preview local: `.Codex/launch.json` sobe o frontend na 3000; backend real não roda local — usar mock na 3001 (endpoints com prefixo `/api`; ver scratchpad de sessões anteriores como referência).
...
Este projeto está em execução ... preciso melhorar visualmente e algumas funcoes usando a nova inteligencia do claude
