 ...
 *
 * Nasceu pra completar a medição de exposição da rede, que mostrava só CPF
 * mascarado (aquele script foi embora junto com a pasta `giga-etl/`, no
 * enterro do Wincred). Aqui
 ...
 *
 * Uso (da RAIZ do repo):
 *   railway run --service Postgres -- node backend/scripts/quem-deve-mais.js [quantos]
 */
