...
export class SellersService {
  ...
  // importFromWincred() foi REMOVIDO no enterro do Wincred (09/2026): lia a
  // tabela `funcionarios` direto no pool MySQL do Giga — morto, respondia
  // "MySQL Wincred não conectado" pra sempre. Vendedora nova nasce no Flow
  // (create/importFromPdvActive); a importação em massa já aconteceu.
