...
| 10 | 🟡 | SEO | `/logo.svg` (logo da Organization) e `/og/default.jpg` (OG padrão) respondem 404; URLs legadas com barra final fazem 2 saltos (308+308); 1.457 "cópia sem canônica" e 1.088 bloqueadas por robots (a conferir amostra) | Assets nunca criados; redirects encadeados | `public/logo.svg` (logotipo oficial em preto) e `public/og/default.jpg` (recorte 1200×630 do hero) — PR #1207. Redirects 308 estão corretos para SEO (equivalem a 301); amostra da GSC fica | `curl`: 200 image/svg+xml 12.285 B · 200 image/jpeg 41.319 B | ✅ assets / ⏸ amostra GSC |
