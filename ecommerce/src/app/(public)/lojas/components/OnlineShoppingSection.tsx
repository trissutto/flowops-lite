...
export default function OnlineShoppingSection({
  ...
  return (
    <section className="border-y border-[var(--lj-line)] bg-white px-6 py-20 sm:py-24" aria-labelledby="comprar-online-titulo">
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-2xl text-center">
          <p className="text-[11px] font-medium uppercase tracking-[0.3em] text-[var(--lj-gold-strong)]">Loja online</p>
          <h2 id="comprar-online-titulo" className="lojas-serif mt-4 text-3xl font-medium sm:text-5xl">
            Prefere receber em casa?
          </h2>
          <p className="mt-5 text-sm font-light leading-relaxed text-[var(--lj-ink-soft)] sm:text-base">
            Os mesmos lançamentos das lojas também estão disponíveis online, com entrega para todo o Brasil.
          </p>
        </div>

        {products.length > 0 && (
          <div className="mt-12 grid grid-cols-2 gap-x-4 gap-y-10 sm:grid-cols-3 lg:grid-cols-6 lg:gap-x-5">
