...
export default function CrediarioJurosConfigPage() {
  ...
  // O painel "criar índice na movimento do Giga" morreu em 27/08: o MySQL do
  // Giga foi desligado e a listagem de parcelas lê a tabela nativa do Flow.
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-rose-50 to-pink-50 p-4 md:p-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-5">
          ...
          {/* O painel "Performance — Índice no Giga" saiu em 09/26 (MySQL do Giga desligado). */}
