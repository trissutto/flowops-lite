 ...
 * <EnviadosByStore />
 *
 * Componente reutilizável que mostra o que cada loja ENVIOU no dia,
 * agrupado por filial, com KPIs + ranking + expansão de detalhes.
 *
 * Historicamente era a tela /retaguarda/enviados-hoje. Foi promovido a
 * componente pra virar aba dentro de /separacao (Emissão de Separações),
 * onde o operacional do dia-a-dia já olha.
 *
 * SEM wrapper de página (nada de `max-w-7xl mx-auto p-6`) — deixa pro
 * parent decidir o layout.
 *
 * Fonte: GET /pick-orders/shipped-by-store?from=YYYY-MM-DD&to=YYYY-MM-DD
...
import {
  ...
  ExternalLink, Repeat, MapPin, Phone, AlertCircle, Loader2, Calendar,
} from 'lucide-react';
...
export default function EnviadosByStore() {
