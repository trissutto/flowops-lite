...
export default function NewOrderAlert() {
  ...
  return (
    <div
      className="fixed inset-0 z-[9999] flex items-start justify-center pt-10 px-4 pointer-events-none"
      aria-live="assertive"
      role="alert"
    >
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-2">
                  <div className="text-3xl font-black text-yellow-900 tracking-tight">
                ...
                <div className="mt-4 flex gap-2 justify-end">
                  <Link
                    href="/separacao"
                    onClick={dismissAll}
                    className="px-4 py-2 bg-yellow-900 text-yellow-100 rounded-lg font-bold hover:bg-yellow-950 transition text-sm"
                  >
                    Abrir Separação →
                  </Link>
                  <button
                    onClick={dismissAll}
                    className="px-4 py-2 bg-yellow-100 text-yellow-900 rounded-lg font-semibold hover:bg-yellow-50 transition text-sm border border-yellow-600"
                  >
                    OK, VI
                  </button>
                </div>
