...
export default function PwaInstallBanner() {
  ...
  if (pathname?.startsWith('/cadastro-live') || pathname?.startsWith('/pagar') || pathname?.startsWith('/pague/') || pathname?.startsWith('/p/') || pathname?.startsWith('/meu-pedido') || pathname?.startsWith('/meus-pedidos') || pathname?.startsWith('/trocas')) return null;
